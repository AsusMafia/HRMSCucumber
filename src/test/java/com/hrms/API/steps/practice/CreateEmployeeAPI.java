...
public class CreateEmployeeAPI {
	...
	public void user_calls_createEmployee_API() {
		 ...
		 * 
		 **/
		request.body(CommonMethods.readJSON("\\Users\\E\\eclipse-workspace\\HRMSCucumberFramework\\src\\test\\resources\\JSONFiles\\createEmployee.json"));
	...
	//	response.then().assertThat().statusLine("200");

	}

	@Then("user validates employee is ceated")
	public void user_validates_employee_is_ceated() {
		/**
